...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "ix_telemetry_measurements_sensor_measured_at", table_name="telemetry_measurements"
    )
    op.drop_index(
        "ix_telemetry_measurements_equipment_measured_at", table_name="telemetry_measurements"
    )
